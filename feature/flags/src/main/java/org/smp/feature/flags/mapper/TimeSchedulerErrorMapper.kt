package org.smp.feature.flags.mapper
...
class TimeSchedulerErrorMapper @Inject constructor(
    ...
    operator fun invoke(digits: List<String>): String? {
        ...
        return when {
            hours == null -> context.getString(R.string.hour_must_be_two_digits_00_23)
            hours !in 0..23 -> context.getString(R.string.hour_is_invalid_must_be_between_00_and_23, hourDigits)
            minutes == null -> context.getString(R.string.minute_must_be_two_digits_00_59)
            minutes !in 0..59 -> context.getString(R.string.minute_is_invalid_must_be_between_00_and_59, minuteDigits)
            seconds == null -> context.getString(R.string.second_must_be_two_digits_00_59)
            seconds !in 0..59 -> context.getString(R.string.second_is_invalid_must_be_between_00_and_59, secondDigits)
            else -> null
        }
    }
}
